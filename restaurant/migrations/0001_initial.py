# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-12-14 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='restaurant.Board')),
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='restaurant.Topic'),
        ),
        migrations.AddField(
            model_name='post',
            name='updated_by',
